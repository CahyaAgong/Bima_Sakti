...
public class Siap_webview extends AppCompatActivity {
    private WebView view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.siap_webview);

        ActionBar menu = getSupportActionBar();
        menu.setDisplayShowHomeEnabled(true);
        menu.setDisplayHomeAsUpEnabled(true);

        view = (WebView) findViewById(R.id.wv_siap);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new Siap_webview.MyBrowser());
        view.loadUrl("http://siap.sukabumikab.go.id/login");
    }
