...
public class Simpeg_webview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.simpeg_webview);
        view = (WebView) findViewById(R.id.wv_simpeg);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new Simpeg_webview.MyBrowser());
        view.loadUrl("http://simpeg.sukabumikab.go.id/login");
    }
