...
public class Sielok_webview extends AppCompatActivity {
    private WebView view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sielok_webview);

        ActionBar menu = getSupportActionBar();
        menu.setDisplayShowHomeEnabled(true);
        menu.setDisplayHomeAsUpEnabled(true);

        view = (WebView) findViewById(R.id.wv_sielok);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new Sielok_webview.MyBrowser());
        view.loadUrl("http://e-lok.sukabumikab.go.id/login");
    }
