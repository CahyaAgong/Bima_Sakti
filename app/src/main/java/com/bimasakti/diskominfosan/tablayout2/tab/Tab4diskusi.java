...
public class Tab4diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_4_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab4diskusi_rec);
