...
public class Tab2diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_2_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab2diskusi_rec);
