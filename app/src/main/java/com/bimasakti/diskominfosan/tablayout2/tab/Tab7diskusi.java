...
public class Tab7diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_7_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab7diskusi_rec);
