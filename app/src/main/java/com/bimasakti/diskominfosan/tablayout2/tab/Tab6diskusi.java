...
public class Tab6diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_6_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab6diskusi_rec);
