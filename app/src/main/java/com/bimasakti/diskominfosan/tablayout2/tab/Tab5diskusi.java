...
public class Tab5diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_5_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab5diskusi_rec);
