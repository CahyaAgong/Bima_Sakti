...
public class Tab3diskusi extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v =inflater.inflate(R.layout.tab_3_diskusi,container,false);

        recyclerView = (RecyclerView) v.findViewById(R.id.tab3diskusi_rec);
