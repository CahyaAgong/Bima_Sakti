...
public class Cart_kuning extends AppCompatActivity {

    private WebView view;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cart_kuning);
        ...
        view = (WebView) findViewById(R.id.wv_cart_kun);
        view.getSettings().setJavaScriptEnabled(true);
        view.setWebViewClient(new MyBrowser());
        view.loadUrl("http://disnakertrans.sukabumikab.go.id/layanan");
    }
