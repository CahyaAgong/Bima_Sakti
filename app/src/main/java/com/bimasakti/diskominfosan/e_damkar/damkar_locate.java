...
//                return true;
    ...
    public void sendDamkarNotif() {
        ...
        Call<ResponseBody> sendNotif = api.sendDamkarNotif(user.getId(), Keys, user.getNama_lengkap(), user.getNohp(), addressget.getText().toString(), datee, user.getNik() + ".jpg");
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        MarkerOptions markerOptions = new MarkerOptions().position(latLng)
                .title("Here I Am..");
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_user_damkar));
